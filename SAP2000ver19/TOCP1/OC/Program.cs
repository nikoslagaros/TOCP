...
namespace OC
{
    class Program
    {
        ...
        public double CalcCompliance(ref SAP2000v19.cSapModel Model, ref bool testbool, string[] SolidName, int SolidNumb, string[] FrameName, int FrameNumb, string[] AreaName, int AreaNumb)
        {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //OC change values in arrays to prepare the next iteration
                for (i = 0; i <= OptiSolidNumb - 1; i++)
                {
                    xk[i] = xnew[i];
                    xkfil[i] = xnewfil[i];
