...
namespace MMA_Divide
{
    class Program
    {
        ...
        public double CalcCompliance(ref SAP2000v15.cSapModel Model, ref bool testbool, string[] SolidName, string SolidNot, int SolidNumb, string[] FrameName, int FrameNumb, string[] AreaName, int AreaNumb)
        {
